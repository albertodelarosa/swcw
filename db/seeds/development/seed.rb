...
require File.join(File.dirname(__FILE__), '..', 'shared', 'create_washing_services.rb')
...
require File.join(File.dirname(__FILE__), '..', 'shared', 'create_development_associations.rb')

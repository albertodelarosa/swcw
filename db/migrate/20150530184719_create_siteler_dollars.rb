class CreateSitelerDollars < ActiveRecord::Migration
  def change
    create_table :siteler_dollars do |t|
      ...
      t.decimal :amount_paid,                 null: false, precision: 8, scale: 2, default: 0.00
      t.decimal :bonus_siteler_dollars,       null: false, precision: 8, scale: 2, default: 0.00
      t.decimal :percentage,                  null: false, precision: 4, scale: 2, default: 0.00
      t.decimal :total_siteler_dollars,       null: false, precision: 8, scale: 2, default: 0.00
      t.decimal :siteler_dollars_remaining,   null: false, precision: 8, scale: 2, default: 0.00

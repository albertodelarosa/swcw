...
ActiveRecord::Schema.define(version: 20130725015326) do
  ...
  add_index "schedules", ["appointment_id", "company_id"], name: "index_schedules_on_appointment_id_and_company_id", using: :btree
  add_index "schedules", ["appointment_id", "site_id"], name: "index_schedules_on_appointment_id_and_site_id", using: :btree
  add_index "schedules", ["appointment_id", "user_id"], name: "index_schedules_on_appointment_id_and_user_id", using: :btree
  add_index "schedules", ["appointment_id", "vehicle_id"], name: "index_schedules_on_appointment_id_and_vehicle_id", using: :btree
  add_index "schedules", ["appointment_id"], name: "index_schedules_on_appointment_id", using: :btree
  add_index "schedules", ["company_id", "site_id"], name: "index_schedules_on_company_id_and_site_id", using: :btree
  add_index "schedules", ["company_id", "user_id"], name: "index_schedules_on_company_id_and_user_id", using: :btree
  add_index "schedules", ["company_id", "vehicle_id"], name: "index_schedules_on_company_id_and_vehicle_id", using: :btree
  add_index "schedules", ["company_id"], name: "index_schedules_on_company_id", using: :btree
  add_index "schedules", ["site_id", "user_id"], name: "index_schedules_on_site_id_and_user_id", using: :btree
  add_index "schedules", ["site_id", "vehicle_id"], name: "index_schedules_on_site_id_and_vehicle_id", using: :btree
  add_index "schedules", ["site_id"], name: "index_schedules_on_site_id", using: :btree
  add_index "schedules", ["user_id"], name: "index_schedules_on_user_id", using: :btree
  add_index "schedules", ["vehicle_id", "user_id"], name: "index_schedules_on_vehicle_id_and_user_id", using: :btree
  ...
  add_index "transportations", ["user_id", "vehicle_id"], name: "index_transportations_on_user_id_and_vehicle_id", unique: true, using: :btree
  add_index "transportations", ["user_id"], name: "index_transportations_on_user_id", using: :btree
  add_index "transportations", ["vehicle_id"], name: "index_transportations_on_vehicle_id", using: :btree

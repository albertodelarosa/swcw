...
ready = ->
  $('#vehicle_selects a').click (e) ->
    e.preventDefault()
    if $(this).is('#vehicle_selects a:first')
      hideInputs()
    if $(this).is('#vehicle_selects a:last')
      hideSelectors()
    $(this).tab 'show'
...
hideSelectors = ->
  ...
  $('#v ehicle_vehicle_makes_id').empty().prepend('<option>Select Make</option>')
  $('#vehicle_vehicle_models_id').empty().prepend('<option>Select Model</option>')
  $('#vehicle_vehicle_trims_id').empty().prepend('<option>Select Trim</option>')
  $('#vehicle_vehicle_types_id').empty().prepend('<option>Select Type</option>')
  $('#vehicle_vehicle_doors_id').empty().prepend('<option>Select Doors</option>')

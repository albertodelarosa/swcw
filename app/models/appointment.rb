class Appointment < ActiveRecord::Base
  ...
  has_many :locations
  has_one :account, through: :locations
  ...
  #def poulate_client
    #self.user_username    = self.account.user.username
    #self.user_email       = self.account.user.email
    #self.user_first_name  = self.account.user.first_name
    #self.user_last_name   = self.account.user.last_name
    #self.user_salutation  = self.account.user.salutation
    #self.user_suffix      = self.account.user.suffix
  #end

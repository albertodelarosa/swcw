class User < ActiveRecord::Base
  ...
  # attr_accessible :email, :username, :password, :password_confirmation, :remember_me, :first_name, :last_name, :salutation, :suffix, :home_address_attributes, :home_address, :home_contact_info_attributes, :home_contact_info, :work_address_attributes, :work_address, :work_contact_info_attributes, :work_contact_info,  :companies_attributes, :vehicles_attributes
